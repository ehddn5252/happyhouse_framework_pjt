...
<main id="main">
	...
	<!-- ======= Portfolio Details Section ======= -->
			...
			<div class="col-sm-7 mt-1" style="min-height: 850px;">
				...
				<div class="row">
					<div class="row form-group form-inline justify-content-center">
						...
						<hr>
							<div class="condition-container col-sm-11" style="margin:auto">
				...
				$(document).on("change", "#dong", function() {
					...
					$("input[name='tmpChkbox[]']:checked").each(function() { 
					      var distance = $(this).siblings("span").find(".form-distance").val(); 
					      var point = $(this).val(); 
				      	...
				      	data: {'dong':$("#dong").val()},
				        	...
				        	success: function (data) {
								...
								$.each(data, function(index, vo) {
									...
									if (!checkCondition(vo,obj)) return false;
		...
		<script type="text/javascript" src="/js/map_sj.js"></script>
